...
namespace StockTicker.Cmd.AccountServiceReference {
    ...
    public partial class ResultModelOfUserModel : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private StockTicker.Cmd.AccountServiceReference.UserModel ResultField;
        ...
        public StockTicker.Cmd.AccountServiceReference.UserModel Result {
            get {
    ...
    public partial class UserModel : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        private StockTicker.Cmd.AccountServiceReference.MemberRole RoleField;
        ...
        public StockTicker.Cmd.AccountServiceReference.MemberRole Role {
            get {
    ...
    public interface AccountWebServiceSoap {
        ...
        StockTicker.Cmd.AccountServiceReference.LoginResponse Login(StockTicker.Cmd.AccountServiceReference.LoginRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Login", ReplyAction="*")]
        System.Threading.Tasks.Task<StockTicker.Cmd.AccountServiceReference.LoginResponse> LoginAsync(StockTicker.Cmd.AccountServiceReference.LoginRequest request);
        ...
        StockTicker.Cmd.AccountServiceReference.RegisterResponse Register(StockTicker.Cmd.AccountServiceReference.RegisterRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Register", ReplyAction="*")]
        System.Threading.Tasks.Task<StockTicker.Cmd.AccountServiceReference.RegisterResponse> RegisterAsync(StockTicker.Cmd.AccountServiceReference.RegisterRequest request);
    }
    ...
    public partial class LoginRequest {
        ...
        public StockTicker.Cmd.AccountServiceReference.LoginRequestBody Body;
        
        public LoginRequest() {
        }
        
        public LoginRequest(StockTicker.Cmd.AccountServiceReference.LoginRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class LoginResponse {
        ...
        public StockTicker.Cmd.AccountServiceReference.LoginResponseBody Body;
        
        public LoginResponse() {
        }
        
        public LoginResponse(StockTicker.Cmd.AccountServiceReference.LoginResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class LoginResponseBody {
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false, Order=0)]
        public StockTicker.Cmd.AccountServiceReference.ResultModelOfUserModel LoginResult;
        
        public LoginResponseBody() {
        }
        
        public LoginResponseBody(StockTicker.Cmd.AccountServiceReference.ResultModelOfUserModel LoginResult) {
    ...
    public partial class RegisterRequest {
        ...
        public StockTicker.Cmd.AccountServiceReference.RegisterRequestBody Body;
        
        public RegisterRequest() {
        }
        
        public RegisterRequest(StockTicker.Cmd.AccountServiceReference.RegisterRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class RegisterResponse {
        ...
        public StockTicker.Cmd.AccountServiceReference.RegisterResponseBody Body;
        
        public RegisterResponse() {
        }
        
        public RegisterResponse(StockTicker.Cmd.AccountServiceReference.RegisterResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class RegisterResponseBody {
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false, Order=0)]
        public StockTicker.Cmd.AccountServiceReference.ResultModelOfUserModel RegisterResult;
        
        public RegisterResponseBody() {
        }
        
        public RegisterResponseBody(StockTicker.Cmd.AccountServiceReference.ResultModelOfUserModel RegisterResult) {
            this.RegisterResult = RegisterResult;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface AccountWebServiceSoapChannel : StockTicker.Cmd.AccountServiceReference.AccountWebServiceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AccountWebServiceSoapClient : System.ServiceModel.ClientBase<StockTicker.Cmd.AccountServiceReference.AccountWebServiceSoap>, StockTicker.Cmd.AccountServiceReference.AccountWebServiceSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        StockTicker.Cmd.AccountServiceReference.LoginResponse StockTicker.Cmd.AccountServiceReference.AccountWebServiceSoap.Login(StockTicker.Cmd.AccountServiceReference.LoginRequest request) {
            return base.Channel.Login(request);
        }
        
        public StockTicker.Cmd.AccountServiceReference.ResultModelOfUserModel Login(string user, string password) {
            StockTicker.Cmd.AccountServiceReference.LoginRequest inValue = new StockTicker.Cmd.AccountServiceReference.LoginRequest();
            inValue.Body = new StockTicker.Cmd.AccountServiceReference.LoginRequestBody();
            inValue.Body.user = user;
            inValue.Body.password = password;
            StockTicker.Cmd.AccountServiceReference.LoginResponse retVal = ((StockTicker.Cmd.AccountServiceReference.AccountWebServiceSoap)(this)).Login(inValue);
            return retVal.Body.LoginResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<StockTicker.Cmd.AccountServiceReference.LoginResponse> StockTicker.Cmd.AccountServiceReference.AccountWebServiceSoap.LoginAsync(StockTicker.Cmd.AccountServiceReference.LoginRequest request) {
            return base.Channel.LoginAsync(request);
        }
        
        public System.Threading.Tasks.Task<StockTicker.Cmd.AccountServiceReference.LoginResponse> LoginAsync(string user, string password) {
            StockTicker.Cmd.AccountServiceReference.LoginRequest inValue = new StockTicker.Cmd.AccountServiceReference.LoginRequest();
            inValue.Body = new StockTicker.Cmd.AccountServiceReference.LoginRequestBody();
            inValue.Body.user = user;
            inValue.Body.password = password;
            return ((StockTicker.Cmd.AccountServiceReference.AccountWebServiceSoap)(this)).LoginAsync(inValue);
        }
